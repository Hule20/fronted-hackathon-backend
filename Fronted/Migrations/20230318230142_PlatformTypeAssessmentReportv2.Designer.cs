...
namespace Fronted.Migrations
{
    ...
    [Migration("20230318230142_PlatformTypeAssessmentReportv2")]
    partial class PlatformTypeAssessmentReportv2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fronted.Models.MaliciousEvent", b =>
                {
                    b.HasOne("Fronted.Models.AssessmentReport", "AssessmentReport")
                        .WithOne("MaliciousEvent")
                        .HasForeignKey("Fronted.Models.MaliciousEvent", "AssessmentReportId")
